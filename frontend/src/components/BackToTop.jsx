...
export default function BackToTop() {
  ...
  return (
    <Tooltip text={t('backToTop.tooltip')} position="left">
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 ltr:right-6 rtl:left-6 z-50 w-12 h-12 flex items-center justify-center transition-all duration-300 ${
          visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'
        }`}
        aria-label={t('backToTop.tooltip')}
      >
